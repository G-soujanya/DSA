...
class LinkedList {
    public static void main(String args[]) {
        ...
        //list.addLast(8);
        //list.display();
        //list.reverseUptoKthElement(2);
        //System.out.println("after reverse");
        //list.reverseEveryKElements(2);
        node n;
        n=list.segrigation(list.head);
        while(n!=null)
        {
...
class linkedlist 
{
    ...
    linkedlist addTwoLinkedlist(linkedlist l1)
    {
        if(l1.head==null)
            return this; 
        if(this.head==null)
        ...
        current.address=l1.head;
        return this;
    }
    void reverseUptoKthElement(int k)
    {
        if(isEmpty())
            throw new IllegalStateException();
        if(k<0 || k>getSize())
    ...
    /*void reversek(int start,int k,node n)
    {
        node current=n;
        node prev=null;
        node next=null;
